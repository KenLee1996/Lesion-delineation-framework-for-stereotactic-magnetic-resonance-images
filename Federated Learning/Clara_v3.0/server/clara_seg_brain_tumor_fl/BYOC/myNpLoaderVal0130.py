...
class MyNumpyLoader(MultiFieldTransformer):
    ...
    def transform(self, transform_ctx: TransformContext):
        ...
        for field in self.fields:
            ...
            transform_ctx.set_image(field, self._reader.read(data, file_name, start0, start1, start_slice, self._shape))
...
class MyNumpyReader(object):
    ...
    def read(self, data, file_name,start0, start1, start_slice, shape: ShapeFormat):
